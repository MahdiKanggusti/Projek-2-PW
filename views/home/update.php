...
<body>
  ...
  <?php
      $hidden = ['idedit'=>$fas->jenis_id];
  ?>
  <?php echo form_open('home/save','',$hidden)?>
  <div class="m-5">
  <form >
    <div class="form-group row">
      <label for="nama" class="col-4 col-form-label">Nama Rumah sakit</label> 
      <div class="col-8">
        <input id="nama" name="nama" value="<?=$fas->nama?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="alamat" class="col-4 col-form-label">Alamat Rumah sakit</label> 
      <div class="col-8">
        <input id="alamat" name="alamat" value="<?=$fas->alamat?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="latlong" class="col-4 col-form-label">Latlong</label> 
      <div class="col-8">
        <input id="latlong" name="latlong" value="<?=$fas->latlong?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        ...
        <?php 
            $checked_rs = ($fas->jenis_id=="1")?"checked":"";
            $checked_kg = ($fas->jenis_id=="2")?"checked":"";
            $checked_ku = ($fas->jenis_id=="3")?"checked":"";
            $checked_p = ($fas->jenis_id=="4")?"checked":"";
            $checked_a = ($fas->jenis_id=="5")?"checked":"";
        ?>
        <option value="1" <?=$checked_rs?>>Rumah Sakit</option>
        <option value="2" <?=$checked_kg?>>Klinik Gigi</option>
        <option value="3" <?=$checked_ku?>>Klinik Umum</option>
        <option value="4" <?=$checked_p?>>Puskesmas</option>
        <option value="5" <?=$checked_a?>>Apotik</option>
        </select>
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        <textarea id="deskripsi" name="deskripsi" value="<?=$fas->deskripsi?>" cols="40" rows="5" class="form-control"></textarea>
      </div>
    </div>
    <div class="form-group row">
      <label for="latlong" class="col-4 col-form-label">Rating</label> 
      <div class="col-8">
        <input id="rating" name="rating" value="<?=$fas->skor_rating?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        ...
        <?php 
            $checked_b = ($fas->kecamatan_id=="1")?"checked":"";
            $checked_p = ($fas->kecamatan_id=="2")?"checked":"";
        ?>
          <option value="1" <?=$checked_b?>>Beji</option>
          <option value="2" <?=$checked_p?>>Pancoran Mas</option>
        </select>
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        <input id="website" name="website" value="<?=$fas->website?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="dokter" class="col-4 col-form-label">Jumlah Dokter</label> 
      <div class="col-8">
        <input id="dokter" name="dokter" value="<?=$fas->jumlah_dokter?>" type="number" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="pegawai" class="col-4 col-form-label">Jumlah Pegawai</label> 
      <div class="col-8">
        <input id="pegawai" name="pegawai" value="<?=$fas->jumlah_pegawai?>" type="number" class="form-control">
      </div>
    </div> 
    <div class="form-group row">
