              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?=$kom->users_id?></td>
                    <td><?=$kom->faskes_id?></td>
                    <td><?=$kom->nilai_rating_id?></td>
                    <td>
                      <a href="<?php echo base_url('komen/delete?id=')?><?=$kom->id?>" class="btn btn-danger btn-sm active" onclick="if(!confirm('Anda Yakin Hapus<?=$kom->users_id?>?')) {return false}">Hapus</a>
                    </td>
                  </tr>
                </tbody>
                <?php
