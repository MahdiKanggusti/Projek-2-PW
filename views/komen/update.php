...
<body>
  ...
  <form>
    <div class="form-group row">
      ...
      <div class="col-8">
        <input id="username" name="username" value="<?=$usrs->username?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="email" class="col-4 col-form-label">Email</label> 
      <div class="col-8">
        <input id="email" name="email" value="<?=$usrs->email?>" type="email" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="status" class="col-4 col-form-label">Status</label> 
      <div class="col-8">
        <input id="status" name="status" value="<?=$usrs->status?>" type="number" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="role" class="col-4 col-form-label">Role</label> 
      <div class="col-8">
        <input id="role" name="role" value="<?=$usrs->role?>" type="text" class="form-control">
      </div>
    </div> 
    <div class="form-group row">
