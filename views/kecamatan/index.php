  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(<?php echo base_url('assets/img/bg_image_1.jpg')?>);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        <h1 class="font-weight-normal">Kelola Kecamatan</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?=$cam->nama?></td>
                            <td>
                                <a href="<?php echo base_url('kecamatan/edit?id=')?><?=$cam->id?>">Edit</a>
                                <a href="<?php echo base_url('kecamatan/delete?id=')?><?=$cam->id?>"
                                onclick="if(!confirm('Anda Yakin Hapus <?=$cam->nama?>?')) {return false}"
                                >Delete</a>
                            </td>
                        </tr>
                    </tbody>
